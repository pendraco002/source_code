...
import { Brain, Heart, Thermometer, Play, Settings, BookOpen, Trophy } from 'lucide-react';
          ...
          >
            ...
            <div className="flex space-x-4">
              <button
                ...
                className="px-6 py-3 bg-gray-500/20 hover:bg-gray-500/30 text-white rounded-lg transition-colors"
              >
                Voltar
              </button>
              <button
